...
/* THIS IS JUST A TEST FILE I NEEDED FOR SOME REASON... YOU CAN DELETE IT */

//session_start();
//include ("../includes/config.php");

//$result = mysql_query("SELECT * FROM df_towns WHERE strExtra != 'none' LIMIT 1") or $error = 1;
//while($r = mysql_fetch_assoc($result)){
//    $replaced = str_replace(",", " OR ZoneID = ", $r['strExtra']);
...
//        if($zones2['Name']=="none"){
//            echo($zones.$zones2['Data']."<br />");
//        } else {
//            echo($zones2['Name']."=".$zones2['Data']."<br />");
//        }
//    }
//    echo("<br /><br />");
    //$result = mysql_query("SELECT * FROM df_towns WHERE strExtra != 'none' LIMIT 1") or $error = 1;
