    ...
    if($user_rows != 1 || $error == 1){
        ...
        if($class['Save'] == 1 && $error != 1){
            ...
            if($class['Save'] == 1 && $user['access'] < 40){
                $reason = "Banned!";
                $message = "You have been banned for trying to access an admin class, If this is incorrect please contact the Server Administrator.";
        ...
        if ($error != 1)
        {
            ...
            $character->setAttribute("PrevClassID", $char['classid']);
